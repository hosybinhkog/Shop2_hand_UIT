...
import noCard from '../../assets/img/no_cart.png';
import qrCode from '../../assets/img/qr_code.png';
import { logout } from '../../redux/actions/userActions';
import { removeItemsFormCart } from '../../redux/actions/cartAction';
  ...
  useEffect(() => {
    window.addEventListener('scroll', () => {
      if (
        ...
        headerRef.current.classList && headerRef.current.classList.add('active');
      } else {
        headerRef.current.classList && headerRef.current.classList.remove('active');
      }
    });
  });
    ...
    <header className="header" ref={headerRef}>
      <div className="grid">
        <nav className="header__navbar">
          <ul className="header__navbar-list">
            <li className="header__navbar-item header__navbar-item--has-qr header__navbar-item--separate">
              Vào cửa hàng trên ứng dụng 2Hand - Ecommerce
              {/* Header QR code */}
              <div className="header__qr">
                <img src={qrCode} alt="QR code" className="header__qr-img" />
                <div className="header__qr-apps">
                  <a href className="header__qr-link">
                    <img src={imgGG} alt="Google Play" className="header__qr-download-img" />
                  </a>
                  <a href className="header__qr-link">
            ...
            <li className="header__navbar-item">
              ...
              <a href className="header__navbar-icon-link">
                <i className="header__navbar-icon bx bxl-facebook-circle" />
              </a>
              <a href className="header__navbar-icon-link">
                <i className="header__navbar-icon bx bxl-instagram" />
              </a>
            </li>
          </ul>
          <ul className="header__navbar-list">
            <li className="header__navbar-item header__navbar-item--has-notify">
              <a href className="header__navbar-item-link">
                <i className="header__navbar-icon bx bx-bell" />
                Thông báo
              </a>
              <div className="header__notify">
                ...
                <footer className="header__notify-footer">
                  <a href className="header__notify-footer-btn">
                    <Link to="/order/me">Xem tất cả</Link>
                  </a>
                </footer>
              </div>
            </li>
            ...
            {isAuthenticated ? (
              <li className="header__navbar-item header__navbar-user">
                ...
                <ul className="header__navbar-user-menu">
                  ...
                  <li className="header__navbar-user-item" onClick={() => navigate('/user/cart')}>
                    Đơn mua
                  </li>
                  <li className="header__navbar-user-item" onClick={() => navigate('/order/me')}>
                    Tất cả giỏ hàng đã mua
                  </li>
                  {user.role === 'admin' ? (
                    <li
        ...
        <div className="header-with-search">
          ...
          <form className="header__search" onSubmit={handleSubmitSearch}>
            ...
            <div className="header__search-select">
              ...
              <i className="header__search-select-icon bx bxs-down-arrow" />
            ...
            <button className="header__search-btn" type="submit">
              <i className="header__search-btn-icon bx bx-search-alt-2" />
            </button>
          </form>
          {/* Cart layout */}
          <div className="header__cart">
            <div className="header__cart-wrap">
              <i className="header__cart-icon bx bx-cart" />
              <span className="header__cart-notice">{cartItems.length}</span>
              {/* No cart: add header__cart-list--no-cart */}
              <div className="header__cart-list">
                <img src={noCard} alt="" className="header__cart-no-cart-img" />
                  ...
                  {cartItems &&
                    cartItems.map((item) => (
                      <li className="header__cart-item">
                        <img src={item.image} alt="" className="header__cart-img" />
                        <div className="header__cart-item-info">
                          <div className="header__cart-item-head">
                            ...
                            <div className="header__cart-item-price-wrap">
                              ...
                              <span className="header__cart-item-miltiply">x</span>
                          ...
                          <div className="header__cart-item-body">
                            ...
                            <span
                              ...
                              onClick={() => handleRemoveItemCart(item.product)}
                            >
                              Xóa
                            </span>
                          </div>
